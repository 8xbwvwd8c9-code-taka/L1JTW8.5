...
public class r {
    private static final int[] a = new int[]{4, 4, 4, 350};
    private static final h[] b = new h[]{new h(33419, 32810), new h(33343, 32723), new h(33553, 32712), new h(32702, 32842)};
    private static final h[] c = new h[]{new h(33604, 33236), new h(33649, 33413), new h(33553, 32712), new h(32702, 32842)};
    private static final h[] d = new h[]{new h(33966, 33253), new h(33921, 33177), new h(33553, 32712), new h(32702, 32842)};
    private static final h[] e = new h[]{new h(32628, 32807), new h(32623, 32729), new h(33553, 32712), new h(32702, 32842)};
    private static final List<Integer> f = ab.b();

    private r() {
    }

    public static boolean a(int houseId, int locx, int locy, int mapid) {
        boolean ret = false;
        if (houseId == 262145) {
    ...
    public static int[] b(int houseId) {
        int[] loc = new int[3];
    ...
    public static boolean a(int locx, int locy, int mapid) {
        boolean result = false;
        for (Integer houseId : f) {
            if (!r.a(houseId, locx, locy, mapid)) continue;
            result = true;
            break;
        }
        return result;
    ...
    public static int[] a(int houseId, int number) {
        int[] loc = new int[3];
        if (houseId >= 262145 && houseId <= 262189) {
            loc[0] = b[number].f();
            loc[1] = b[number].g();
