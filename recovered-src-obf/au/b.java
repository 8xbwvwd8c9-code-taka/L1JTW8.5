        ...
        block6: {
            ...
            try {
                try {
                    ...
                    pstm = con.prepareStatement("SELECT * FROM character_warehouse_only WHERE char_objid = ?");
                    pstm.setInt(1, this.h.fr());
    ...
    public void b(q item) {
        block5: {
            ...
            try {
                try {
                    con = l1j.server.b.a().b();
                    pstm = con.prepareStatement("UPDATE character_warehouse_only SET count = ? WHERE id = ?");
    ...
    public void c(q item) {
        block5: {
            ...
            try {
                try {
                    con = l1j.server.b.a().b();
                    pstm = con.prepareStatement("DELETE FROM character_warehouse_only WHERE id = ?");
                    pstm.setInt(1, item.fr());
                    pstm.execute();
                }
                catch (SQLException e2) {
