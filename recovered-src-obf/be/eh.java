...
public class eh
extends eu {
    public eh(z pet, u pc) {
        this.a(pet, pc, true);
    }

    public eh(z pet, u pc, boolean isCheckMaster) {
        this.a(pet, pc, isCheckMaster);
    }

    private void a(z pet, u pc, boolean isCheckMaster) {
        this.c(1);
        this.b(119);
