...
extends eu {
    ...
    public v(int type, int objid, int emblemId) {
        this.c(42);
        this.c(type);
        this.a(objid);
        this.a(emblemId);
    ...
    public v(HashMap<Integer, bd.b> list) {
        this.c(42);
        this.c(36);
        this.c(1);
        this.c(1);
        this.c(1);
        this.b(list.size());
        ArrayList<bd.b> arrayList = new ArrayList<bd.b>(list.values());
        Collections.sort(arrayList, new Comparator<bd.b>(){

            public int a(bd.b d1, bd.b d2) {
                if (d2.f && d1.f) {
            ...
            public /* synthetic */ int compare(Object object, Object object2) {
                return this.a((bd.b)object, (bd.b)object2);
            }
        });
        for (bd.b data : arrayList) {
            q item = data.a;
            this.a(item.N());
            this.b(item.e());
            this.b(item.m());
