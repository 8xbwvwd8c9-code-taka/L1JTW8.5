...
extends aa {
    ...
    public void b(int i2) {
        this.U = Math.max(0, Math.min(i2, 127));
    }
    ...
    public String c(int count) {
        ...
        int itemId = this.N();
        if ((itemId == 40314 || itemId == 40316) && (pet = ao.aw.a().b(this.fr())) != null) {
            l npc = ao.au.a().a(pet.c());
    ...
    public byte[] t() {
        ...
        if (petItem != null) {
            ...
            ArrayList<c.a> resultList = ao.c.a().a(this.N());
            for (c.a as2 : resultList) {
                if (as2.b().length > 1) {
                    os.c(39);
                    os.a("\\aL" + as2.A());
    ...
    public void b(u pc, int skillTime) {
        ...
        this.ac = 3;
        this.ah = pc;
        this.ag = bi.e.a().a(new b(), skillTime);
    }

    public void a(u pc, int skillId, int skillTime) {
        if (pc == null || !this.g()) {
            return;
        }
        if (this.ag != null) {
    ...
    public void d(u pc) {
        this.ai = pc.fr();
        bi.e.a().a(new c(), 10000L);
    }

    public void e(u pc) {
        if (this.M() > 0) {
            this.aj = bi.e.a().a(new a(pc), 1000L, 1000L);
        }
    }
