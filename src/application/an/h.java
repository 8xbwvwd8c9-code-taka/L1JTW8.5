...
public final class h {
    ...
    static {
        ...
        k.g.a assigner = new k.g.a(){
            ...
            public m a(k.g root) {
                k = root;
                a = an.h.a().e().get(0);
                b = new p.g(a, new String[]{"Value1", "Value2", "Array3", "Array4", "Array5", "Array6", "Array7", "Array8", "Array9", "Value10", "Value11", "Value12", "Value13", "Value14", "Value15"});
                c = an.h.a().e().get(1);
                d = new p.g(c, new String[]{"Array1", "Value2", "Value3", "Value4", "Value5", "Value6", "Value7", "Value8", "Value9", "Value10", "Value11", "Value12", "Value13", "Value14", "Value15"});
                e = an.h.a().e().get(2);
                f = new p.g(e, new String[]{"Value1", "Value2", "Array3", "Array4", "Value5", "Value6", "Array7", "Value8", "Value9", "Value10", "Value11", "Value12", "Value13", "Value14", "Value15"});
                g = an.h.a().e().get(3);
                h = new p.g(g, new String[]{"Value1", "Value2", "Array3", "Value4", "Array5", "Array6", "Array7", "Array8", "Array9", "Value10", "Value11", "Value12", "Value13", "Value14", "Value15"});
                i = an.h.a().e().get(4);
                j = new p.g(i, new String[]{"Value1", "Value2", "Array3", "Array4", "Value5", "Value6", "Value7", "Value8", "Value9", "Value10", "Value11", "Value12", "Value13", "Value14", "Value15"});
                return null;
            }
        };
    ...
    public static final class an.h$a
    extends p
    implements b {
        private static final an.h$a r;
        private final ap s;
        public static ab<an.h$a> a;
        private int t;
        ...
        static {
            a = new a.c<an.h$a>(){
                ...
                public an.h$a c(a.h input, n extensionRegistry) throws s {
                    return new an.h$a(input, extensionRegistry);
                }
        ...
        private an.h$a(p.a<?> builder) {
            super(builder);
            this.s = builder.b_();
        }

        private an.h$a(boolean noInit) {
            this.s = ap.c();
        }
        ...
        private an.h$a(a.h input, n extensionRegistry) throws s {
            this.ag();
        ...
        @Override
        protected p.g l() {
            return j.a(an.h$a.class, a.class);
        }
        ...
        public static an.h$a a(a.g data) throws s {
            return a.d(data);
        }

        public static an.h$a a(a.g data, n extensionRegistry) throws s {
            return a.d(data, extensionRegistry);
        }

        public static an.h$a a(byte[] data) throws s {
            return a.d(data);
        }

        public static an.h$a a(byte[] data, n extensionRegistry) throws s {
            return a.d(data, extensionRegistry);
        }

        public static an.h$a a(InputStream input) throws IOException {
            return a.h(input);
        }

        public static an.h$a a(InputStream input, n extensionRegistry) throws IOException {
            return a.h(input, extensionRegistry);
        }

        public static an.h$a b(InputStream input) throws IOException {
            return a.f(input);
        }

        public static an.h$a b(InputStream input, n extensionRegistry) throws IOException {
            return a.f(input, extensionRegistry);
        }

        public static an.h$a a(a.h input) throws IOException {
            return a.d(input);
        }

        public static an.h$a a(a.h input, n extensionRegistry) throws IOException {
        ...
        public static a a(an.h$a prototype) {
            return an.h$a.aa().a(prototype);
        }

        public a ae() {
            return an.h$a.a(this);
        }
        ...
        implements b {
            ...
            public an.h$a M() {
                an.h$a result = this.N();
                if (!result.a()) {
                    throw an.h$a$a.b(result);
                }
                return result;
            }

            public an.h$a N() {
                an.h$a result = new an.h$a(this);
            ...
            public a d(x other) {
                if (other instanceof an.h$a) {
                    return this.a((an.h$a)other);
                }
                super.a(other);
                return this;
            }

            public a a(an.h$a other) {
                if (other == an.h$a.h()) {
                    return this;
                }
                if (other.o()) {
            ...
            public a e(a.h input, n extensionRegistry) throws IOException {
                an.h$a parsedMessage = null;
                try {
                    try {
                        parsedMessage = a.d(input, extensionRegistry);
                    }
                    catch (s e2) {
                        parsedMessage = (an.h$a)e2.a();
                        throw e2;
                    }
                }
                finally {
    ...
    implements d {
        ...
        public static a a(c prototype) {
            return an.h$c.aa().a(prototype);
        }

        public a ae() {
            return an.h$c.a(this);
        }
    ...
    implements f {
        ...
        public static a a(e prototype) {
            return an.h$e.aa().a(prototype);
        }

        public a ae() {
            return an.h$e.a(this);
        }
    ...
    implements h {
        ...
        public static a a(g prototype) {
            return an.h$g.aa().a(prototype);
        }

        public a ae() {
            return an.h$g.a(this);
        }
    ...
    implements j {
        ...
        public static a a(i prototype) {
            return an.h$i.aa().a(prototype);
        }

        public a ae() {
            return an.h$i.a(this);
        }
