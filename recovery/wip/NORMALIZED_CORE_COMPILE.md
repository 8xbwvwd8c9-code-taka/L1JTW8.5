...
| name clash: compare(Object,Object) in <anonymous l1r.ao.RankingTable$1> and compare(RankingTable.L1R_a,RankingTable.L1R_a) in Comparator have the same erasure, yet neither overrides the other | 1 |
| <anonymous l1r.ao.ShopTable$1> is not abstract and does not override abstract method compare(L1ShopItem,L1ShopItem) in Comparator | 1 |
| name clash: compare(Object,Object) in <anonymous l1r.ao.ShopTable$1> and compare(L1ShopItem,L1ShopItem) in Comparator have the same erasure, yet neither overrides the other | 1 |
