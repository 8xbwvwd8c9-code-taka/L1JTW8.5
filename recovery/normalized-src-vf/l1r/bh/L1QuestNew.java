...
public class L1QuestNew {
   ...
   public void a(int var1) {
      if (!this.x) {
         this.z = var1 > this.n ? this.n : var1;
         this.D();
      }
   }

   public void b(int var1) {
      if (!this.x && this.A[var1] < this.q[var1]) {
         this.A[var1]++;
         this.D();
      }
   }
   ...
   public void a(int var1, int var2) {
      if (!this.x) {
         this.B[var1] = var2 > this.s[var1] ? this.s[var1] : var2;
         this.D();
      }
   }

   public void c(int var1) {
      if (!this.x && this.C[var1] < this.v[var1]) {
         this.C[var1]++;
         this.D();
      }
   }
