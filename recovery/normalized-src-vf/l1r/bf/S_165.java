...
public class S_165 extends L1SkillExecutor {
   private final int a = 165;
   private final L1Skills b = SkillsTable.a().a(165);
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6 instanceof L1Character) {
         ...
         this.b(var1, this.b);
         this.a(var7, this.b);
         if (var7.eX() && !var7.bB(165) && var1.fr() != var7.fr() && !(var7 instanceof L1TowerInstance)) {
