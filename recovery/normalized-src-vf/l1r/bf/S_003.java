...
public class S_003 extends L1SkillExecutor {
   private final int a = 3;
   private final L1Skills b = SkillsTable.a().a(3);
   ...
   public void a(L1Character var1, int var2) {
      ...
      if (var1 instanceof L1PcInstance) {
         ...
         var3.a(new S_SkillIconShield(2, var2));
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      var1.j(3, this.b.v() * 1000);
      this.b(var1, this.b);
      this.a(var1, this.b);
      if (var1 instanceof L1PcInstance) {
         L1PcInstance var6 = (L1PcInstance)var1;
         var6.a(new S_SkillIconShield(2, this.b.v()));
   ...
   public void a(L1Character var1) {
      ...
      if (var1 instanceof L1PcInstance) {
         ...
         var2.a(new S_SkillIconShield(2, 0));
      }
   }
}
