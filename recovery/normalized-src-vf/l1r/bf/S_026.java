...
public class S_026 extends L1SkillExecutor {
   private final int a = 26;
   private final L1Skills b = SkillsTable.a().a(26);
   ...
   public void a(L1Character var1, int var2) {
      ...
      if (var1 instanceof L1PcInstance) {
         ...
         var3.a(new S_Dexup(var3, 5, var2));
      }
   }
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      if (var1 instanceof L1PcInstance && var6 instanceof L1PcInstance) {
         ...
         if (var8.fr() == var7.fr() || var7.aF() != 0 && var7.aF() == var8.aF()) {
            ...
            var8.j(26, this.b.v() * 1000);
            this.a(var8, this.b);
            var8.a(new S_Dexup(var8, 5, this.b.v()));
            this.b(var8, 294);
         } else {
            this.b(var1, 79);
         }
