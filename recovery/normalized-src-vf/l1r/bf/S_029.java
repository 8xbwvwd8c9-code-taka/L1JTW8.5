...
public class S_029 extends L1SkillExecutor {
   private final int a = 29;
   private final L1Skills b = SkillsTable.a().a(29);
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6 instanceof L1Character) {
         ...
         if (var7 instanceof L1PcInstance && ((L1PcInstance)var7).bU() > 0) {
            ...
            boolean var9 = var8.a(29);
            if (var9) {
               var7.j(29, this.b.v() * 1000);
               this.a(var7, this.b);
               this.b(var7, 277);
               switch (var7.fc()) {
                  case 0:
