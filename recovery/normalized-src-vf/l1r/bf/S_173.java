...
public class S_173 extends L1SkillExecutor {
   private final int a = 173;
   private final L1Skills b = SkillsTable.a().a(173);
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6 instanceof L1Character) {
         ...
         boolean var9 = var8.a(173);
         if (var9) {
            var7.j(173, this.b.v() * 1000);
            this.a(var7, this.b);
         } else {
            this.b(var1, 280);
         }
