...
public class S_149 extends L1SkillExecutor {
   private final int a = 149;
   private final L1Skills b = SkillsTable.a().a(149);
   ...
   public void a(L1Character var1, int var2) {
      ...
      var1.j(149, var2 * 1000);
      if (var1 instanceof L1PcInstance) {
         L1PcInstance var3 = (L1PcInstance)var1;
         var3.a(new S_SkillIconAura(148, var2, var3));
      }
   }
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6 instanceof L1Character) {
         ...
         var7.j(149, this.b.v() * 1000);
         this.b(var1, this.b);
         this.a(var7, this.b);
         if (var7 instanceof L1PcInstance) {
            L1PcInstance var8 = (L1PcInstance)var7;
            var8.a(new S_SkillIconAura(148, this.b.v(), var8));
         }
      }
   }
   ...
   public void a(L1Character var1) {
      ...
      if (var1 instanceof L1PcInstance) {
         ...
         var2.a(new S_SkillIconAura(148, 0, var2));
      }
   }
}
