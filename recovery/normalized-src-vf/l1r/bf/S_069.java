...
public class S_069 extends L1SkillExecutor {
   private final int a = 69;
   private final L1Skills b = SkillsTable.a().a(69);
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      if (var1 instanceof L1PcInstance) {
         ...
         if (var6.aF() != 0) {
            for (L1PcInstance var11 : L1World.a().c(var6, 3)) {
               if (var11.aF() == var6.aF()) {
                  var11.a(new S_Message_YN(744));
                  var11.a(var3, var4, var9);
               }
            }
         }

         L1SpawnEffect.a().a(this.b.t(), 5000, var6.fs(), var6.ft(), var6.fp());
