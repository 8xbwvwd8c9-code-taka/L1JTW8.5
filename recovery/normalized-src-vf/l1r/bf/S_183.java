...
public class S_183 extends L1SkillExecutor {
   private final int a = 183;
   private final L1Skills b = SkillsTable.a().a(183);
   ...
   public void a(L1Character var1, int var2, int var3, int var4, String var5) {
      ...
      if (var6 instanceof L1Character) {
         ...
         boolean var9 = var8.a(183);
         if (var9 && !var7.bB(183)) {
            var7.j(183, this.b.v() * 1000);
            this.a(var7, this.b);
            var7.bL(10);
            if (var7 instanceof L1PcInstance) {
               L1PcInstance var10 = (L1PcInstance)var7;
               var10.a(new S_OwnCharAttrDef(var10));
            }
         } else {
            this.b(var1, 280);
         }
