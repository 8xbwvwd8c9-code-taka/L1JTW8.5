...
public class L1CharInventory extends L1Inventory {
   private static final Logger g = Logger.getLogger(L1CharInventory.class.getName());
   private final L1PcInstance h;

   public L1CharInventory(L1PcInstance var1) {
      this.h = var1;
   }
   ...
   public void a() {
      ...
      try {
         ...
         var2 = var1.prepareStatement("SELECT * FROM character_warehouse_only WHERE char_objid = ?");
         var2.setInt(1, this.h.fr());
   ...
   public void a(L1ItemInstance var1) {
      ...
      try {
         ...
         var3 = var2.prepareStatement(
            "INSERT INTO character_warehouse_only SET id = ?, char_objid = ?, item_id = ?, item_name = ?, count = ?, is_equipped=0, enchantlvl = ?, is_id = ?, durability = ?, charge_count = ?, temp_value = ?, last_used = ?, bless = ?, attr_enchant_kind = ?, attr_enchant_level = ?,super_enchant_field_1 = ? ,super_enchant_field_2 = ?,super_enchant_field_3 = ? ,super_enchant_field_4=?,limit_time=?"
         );
         var3.setInt(1, var1.fr());
         var3.setInt(2, this.h.fr());
   ...
   public void b(L1ItemInstance var1) {
      ...
      try {
         var2 = DatabaseFactory.a().b();
         var3 = var2.prepareStatement("UPDATE character_warehouse_only SET count = ? WHERE id = ?");
   ...
   public void c(L1ItemInstance var1) {
      ...
      try {
         var2 = DatabaseFactory.a().b();
         var3 = var2.prepareStatement("DELETE FROM character_warehouse_only WHERE id = ?");
         var3.setInt(1, var1.fr());
         var3.execute();
      } catch (SQLException var8) {
         g.log(Level.SEVERE, var8.getLocalizedMessage(), var8);
