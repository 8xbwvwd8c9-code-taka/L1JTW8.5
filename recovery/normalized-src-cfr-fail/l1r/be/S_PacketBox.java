...
extends ServerBasePacket {
    ...
    public S_PacketBox(byte[] b) {
        this.a(b);
    }

    public S_PacketBox(L1PcInstance pc, int val) {
        this.c(121);
        this.c(val);
        this.b(1800);
        this.b(3600);
    ...
    public S_PacketBox(int subCode, byte[] b) {
        this.c(121);
        this.c(subCode);
        switch (subCode) {
            case 188: {
    ...
    public S_PacketBox(int subCode, L1PcInstance pc, int type, int time) {
        this.c(121);
        this.c(subCode);
        switch (subCode) {
            case 53: {
    ...
    public S_PacketBox(int subCode, int value) {
        ...
        switch (subCode) {
            ...
            case 146: {
                CopyOnWriteArrayList<L1PcInstance> list = L1Master.a().b(value);
                if (list != null) {
                    this.c(list.size());
    ...
    public S_PacketBox(int subCode, String[] names, int[] value) {
        this.c(121);
        this.c(subCode);
        switch (subCode) {
            case 159: {
