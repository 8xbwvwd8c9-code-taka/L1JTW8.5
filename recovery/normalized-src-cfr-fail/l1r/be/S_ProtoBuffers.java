...
extends ServerBasePacket {
    ...
    public S_ProtoBuffers(int type) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 126: {
                PBMessageALL.L1R_a.L1R_a builderb = PBMessageALL.L1R_a.aa();
                builderb.a(0);
                builderb.b(1);
                this.a(builderb.M().g());
                break;
            ...
            case 141: {
                ...
                int i2 = 1;
                while (i2 <= 3) {
                    PBMessageALL8.L1R_e.L1R_a builder = PBMessageALL8.L1R_e.aa();
                    builder.a(i2);
                    String http = "http://g.lineage.power.plaync.com/wiki/%EC%97%90%EB%A5%B4%EC%9E%90%EB%B2%A0";
                    builder.e(LineageUtil.a("http://g.lineage.power.plaync.com/wiki/%EC%97%90%EB%A5%B4%EC%9E%90%EB%B2%A0"));
                    builder.f(LineageUtil.a(texts[i2]));
                    builder.c(L1World.a().b[i2]);
                    builder.d(L1World.a().b[i2] + (i2 == 3 ? 2400 : 600));
                    PBMessageALL5.L1R_c.L1R_a builder17 = PBMessageALL5.L1R_c.aa();
                    builder17.e(LineageUtil.a("4654"));
                    builder17.a(1000);
                ...
                PBMessageALL8.L1R_e.L1R_a builder = PBMessageALL8.L1R_e.aa();
                builder.a(12);
                builder.e(LineageUtil.a(""));
                builder.f(LineageUtil.a("$25034"));
                builder.c(time);
                builder.d(time + 3600);
                PBMessageALL5.L1R_c.L1R_a builder17 = PBMessageALL5.L1R_c.aa();
                builder17.e(LineageUtil.a("4654"));
    ...
    public S_ProtoBuffers(int type, int[][] value) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 810: {
                PBMessageALL.L1R_g.L1R_a builder1114 = PBMessageALL.L1R_g.aa();
                PBMessageALL7.L1R_i.L1R_a builder115 = PBMessageALL7.L1R_i.aa();
                PBMessageALL7.L1R_g.L1R_a builder124 = PBMessageALL7.L1R_g.aa();
                PBMessageALL5.L1R_e.L1R_a builder118 = PBMessageALL5.L1R_e.aa();
                PBMessageALL.L1R_a.L1R_a builder1111 = PBMessageALL.L1R_a.aa();
                builder118.a(1);
                builder118.b(721306);
                builder118.c(0);
                builder1111.a(17368);
                ...
                builder118.e(builder1111.M().f());
                builder124.e(builder118.M().f());
                PBMessageALL.L1R_a.L1R_a builder111 = PBMessageALL.L1R_a.aa();
                builder111.a(1);
                ...
                int i2 = 0;
                while (i2 < 3) {
                    PBMessageALL5.L1R_a.L1R_a builder116 = PBMessageALL5.L1R_a.aa();
                    builder116.b(i2);
    ...
    public S_ProtoBuffers(int type, int value) {
        ...
        switch (type) {
            case 800: {
                PBMessageALL.L1R_a.L1R_a bue1 = PBMessageALL.L1R_a.aa();
                bue1.a(value);
                this.a(bue1.M().g());
                this.b(0);
                break;
            ...
            case 525: {
                PBMessageALL.L1R_a.L1R_a bu11 = PBMessageALL.L1R_a.aa();
                bu11.a(0);
                bu11.b(value);
                this.a(bu11.M().g());
                this.b(0);
            ...
            case 487: {
                ...
                nArray[3] = 45;
                int[] guides = nArray;
                PBMessageALL6.L1R_c.L1R_a bu22 = PBMessageALL6.L1R_c.aa();
                PBMessageALL.L1R_a.L1R_a bu_str = PBMessageALL.L1R_a.aa();
                ...
                bu22.e(bu_str.M().f());
                PBMessageALL.L1R_a.L1R_a bu_int = PBMessageALL.L1R_a.aa();
                ...
                bu22.f(bu_int.M().f());
                PBMessageALL.L1R_a.L1R_a bu_wis = PBMessageALL.L1R_a.aa();
                bu_wis.a(guides[value]);
                bu_wis.b(isMax ? 3 : 1);
                bu_wis.c(isMax ? 3 : 1);
                bu_wis.g(50 * value);
                bu22.g(bu_wis.M().f());
                PBMessageALL.L1R_a.L1R_a bu_dex = PBMessageALL.L1R_a.aa();
                ...
                bu22.h(bu_dex.M().f());
                PBMessageALL.L1R_a.L1R_a bu_con = PBMessageALL.L1R_a.aa();
                ...
                bu_con.f(50 * value);
                bu22.i(bu_con.M().f());
                PBMessageALL.L1R_a.L1R_a bu_cha = PBMessageALL.L1R_a.aa();
                bu_cha.a(-1);
                bu22.j(bu_cha.M().f());
                this.a(bu22.M().g());
                this.b(0);
            ...
            case 123: {
                PBMessageALL.L1R_a.L1R_a bu = PBMessageALL.L1R_a.aa();
                bu.a(value);
                this.a(bu.M().g());
                this.b(0);
                break;
            ...
            case 450: {
                PBMessageALL.L1R_a.L1R_a buildert = PBMessageALL.L1R_a.aa();
                buildert.a(value);
                this.a(buildert.M().g());
                this.b(0);
                break;
            ...
            case 103: {
                PBMessageALL4.L1R_g.L1R_a builder141 = PBMessageALL4.L1R_g.aa();
                builder141.a(14144);
            ...
            case 76: {
                PBMessageALL4.L1R_g.L1R_a builder14 = PBMessageALL4.L1R_g.aa();
                builder14.a(1);
                builder14.b(0);
                builder14.e(LineageUtil.a(""));
            ...
            case 93: {
                PBMessageALL.L1R_a.L1R_a builderc = PBMessageALL.L1R_a.aa();
                builderc.a(0);
                builderc.b(value);
                this.a(builderc.M().g());
                this.b(0);
    ...
    public S_ProtoBuffers(int type, byte[] data) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 123: {
     ...
     */
    public S_ProtoBuffers(int type, L1PcInstance pc) {
        super();
        this.c(1);
        this.b(type);
        switch (type) {
            case 803: {
                builder38 = PBMessageALL3.L1R_g.aa();
                builder108 = PBMessageALL3.L1R_a.aa();
                builder108.b(1);
                builder108.e(LineageUtil.a("\u53e4\u9b6f\u4e01\u5730\u76e3"));
                builder108.c(pc.cS());
                builder108.d(21600);
                builder38.e(builder108.M().f());
                builder108.b(2);
                builder108.e(LineageUtil.a("\u65b0\u5922\u5e7b\u4e4b\u5cf6"));
                builder108.c(pc.cW());
                builder108.d(7200);
                builder38.e(builder108.M().f());
            ...
            case 113: {
                builder118 = PBMessageALL5.L1R_e.aa();
                ip = Config.f;
                splite = ip.split("\\.");
                ...
                builder118.b(Config.g);
                builder118.c(1);
                text = String.valueOf(pc.bc()) + "-" + pc.eu();
                builder118.e(LineageUtil.a(text));
                builder118.d(3);
            ...
            case 559: {
                bu1 = PBMessageALL.L1R_c.aa();
                bu1.b(0);
                bu1.c(0);
                i = 0;
                while (i < pc.dQ().length) {
                    stage = MonsterListReader.a().a(i, pc.dQ()[i]);
                    if (stage > 0) {
                        idx = i * 3;
                        while (idx <= i * 3 + stage - 1) {
                            builder = PBMessageALL.L1R_a.aa();
            ...
            case 489: {
                builderx = PBMessageALL.L1R_a.aa();
                builderx.a(pc.bB());
                this.a(builderx.M().g());
                this.b(0);
                break;
            ...
            case 490: {
                builderb = PBMessageALL.L1R_a.aa();
                builderb.a(pc.bf());
                builderb.b(pc.bj());
                builderb.c(pc.bk());
                builderb.d(pc.bh());
            ...
            case 485: {
                builderl = PBMessageALL.L1R_a.aa();
                builderl.a(pc.j().h());
                builderl.b(pc.j().e());
                builderl.c((int)pc.K());
                this.a(builderl.M().g());
            ...
            case 325: {
                builder180 = PBMessageALL5.L1R_e.aa();
                builder180.a(2);
            ...
            case 327: {
                builder181 = PBMessageALL5.L1R_e.aa();
                builder181.a(0);
            ...
            case 333: {
                ...
                builder18 = PBMessageALL5.L1R_e.aa();
                builder18.a(1);
                builder18.b(clan.q());
                builder18.c(clan.r());
            ...
            case 76: {
                l1clan = ClanTable.a().a(pc.aF());
                currentWar = L1World.a().c(pc.aG());
                builder14 = PBMessageALL4.L1R_g.aa();
                builder14.a(l1clan.a() != false ? 2 : 1);
                if (currentWar != null) {
                    name = currentWar.c(pc.aG()).get(0).f();
                    builder14.b(currentWar.a() * 2);
                    builder14.e(LineageUtil.a(name));
                    this.a(builder14.M().g());
                }
                this.b(0);
                break;
            ...
            case 539: {
                builder = PBMessageALL3.L1R_c.aa();
                builder.a(2);
                builder.e(LineageUtil.a(pc.et()));
                this.a(builder.M().g());
                this.b(0);
                break;
            }
            case 461: {
                builder8 = PBMessageALL3.L1R_g.aa();
                con = null;
                pstm = null;
                rs = null;
                try {
                    try {
                        ...
                        while (rs.next()) {
                            builder1 = PBMessageALL4.L1R_e.aa();
                            builder1.a(Config.a);
                            ...
                            builder1.d(0);
                            builder1.e(a.g.a(rs.getString("char_name").getBytes(Config.k)));
                        ...
                        S_ProtoBuffers.ao.log(Level.SEVERE, e.getLocalizedMessage(), e);
...
lbl239:
    ...
    public S_ProtoBuffers(int type, int value, int value2, int value3) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 813: {
            ...
            case 125: {
                PBMessageALL3.L1R_c.L1R_a builder6 = PBMessageALL3.L1R_c.aa();
                builder6.a(value);
                PBMessageALL.L1R_a.L1R_a builderp = PBMessageALL.L1R_a.aa();
                builderp.a(value2);
                builderp.b(value3);
    ...
    public S_ProtoBuffers(int type, int value, int value2) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 564: 
            ...
            case 568: 
            case 814: {
                PBMessageALL.L1R_a.L1R_a bu01 = PBMessageALL.L1R_a.aa();
                bu01.a(value);
                bu01.b(value2);
                this.a(bu01.M().g());
                this.b(0);
            ...
            case 65: {
                PBMessageALL.L1R_a.L1R_a builderm = PBMessageALL.L1R_a.aa();
                builderm.a(value);
                builderm.b(value2);
                this.a(builderm.M().g());
                this.b(0);
            ...
            case 320: {
                PBMessageALL.L1R_a.L1R_a builderE = PBMessageALL.L1R_a.aa();
                builderE.a(value);
                builderE.b(2);
                builderE.c(value2);
                this.a(builderE.M().g());
    ...
    public S_ProtoBuffers(int type, L1Craft craft, L1ItemInstance craft_item, int value) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 59: {
                PBMessageALL4.L1R_c.L1R_a builder12 = PBMessageALL4.L1R_c.aa();
                builder12.a(value);
    ...
    public S_ProtoBuffers(int type, L1Craft craft, int value) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 55: {
                this.c(8);
                this.c(value);
                PBMessageALL3.L1R_a.L1R_a builder = PBMessageALL3.L1R_a.aa();
                builder.e(craft.i());
                this.a(builder.M().g());
                this.b(0);
            }
    ...
    public S_ProtoBuffers(int type, String ... data) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 57: {
            ...
            case 337: {
                PBMessageALL3.L1R_a.L1R_a build10 = PBMessageALL3.L1R_a.aa();
                build10.b(1);
                String[] stringArray = data;
                int n4 = data.length;
                int n5 = 0;
                while (n5 < n4) {
                    ...
                    if (s.trim().length() != 0) {
                        PBMessageALL5.L1R_c.L1R_a builder17 = PBMessageALL5.L1R_c.aa();
                        builder17.e(LineageUtil.a(s));
                        int isOnLine = L1World.a().a(s) == null ? 0 : 1;
                        builder17.a(isOnLine);
                        builder17.f(LineageUtil.a(""));
    ...
    public S_ProtoBuffers(SoulTowerTable.L1R_a ... ranks) {
        this.c(1);
        this.b(335);
        PBMessageALL4.L1R_i.L1R_a builder15 = PBMessageALL4.L1R_i.aa();
        SoulTowerTable.L1R_a[] l1R_aArray = ranks;
        int n2 = ranks.length;
        int n3 = 0;
        while (n3 < n2) {
            SoulTowerTable.L1R_a rank = l1R_aArray[n3];
            PBMessageALL8.L1R_i.L1R_a builder8 = PBMessageALL8.L1R_i.aa();
            builder8.e(LineageUtil.a(rank.a));
            builder8.a(rank.b);
            builder8.b(rank.c);
    ...
    public S_ProtoBuffers(int type, L1Castle ... castleList) {
        this.c(1);
        this.b(type);
        PBMessageALL3.L1R_g.L1R_a builder8 = PBMessageALL3.L1R_g.aa();
        L1Castle[] l1CastleArray = castleList;
        int n2 = castleList.length;
        int n3 = 0;
        while (n3 < n2) {
            L1Castle castle = l1CastleArray[n3];
            if (castle.a() != 3) {
                String clanName = "\u5b89\u5b89\u59b3\u597d\u518d\u898b_" + castle.a();
                String clanLeaderName = "Srwh";
                L1Clan clan = ClanTable.a().a(castle.g());
                if (clan != null) {
                    clanName = clan.f();
                ...
                builder12.e(LineageUtil.a(clanName));
                builder12.f(LineageUtil.a(clanLeaderName));
    ...
    public S_ProtoBuffers(int type, int val, String s) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 540: {
    ...
    public S_ProtoBuffers(int type, ArrayList<Integer> list) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 401: {
    ...
    public S_ProtoBuffers(int id, int time, int unit, int icon, int iconEnd, int stringc, int startMsg, int endMsg, int seq) {
        this.c(1);
        this.b(110);
        PBMessageALL.L1R_a.L1R_a builder = PBMessageALL.L1R_a.aa();
    ...
    public S_ProtoBuffers(HashMap<Integer, L1ItemInstance> list, int type) {
        this.c(1);
        this.b(101);
        PBMessageALL.L1R_c.L1R_a builder2 = PBMessageALL.L1R_c.aa();
        builder2.b(99);
        ...
        for (int key : list.keySet()) {
            ...
            PBMessageALL2.L1R_a.L1R_a builder = PBMessageALL2.L1R_a.y();
            builder.a(item.N());
            builder.b(item.E());
            builder.c(item.e());
            builder.d(key);
            builder.e(LineageUtil.a(item.b()));
    ...
    public S_ProtoBuffers(int type, String field, int ... data) {
        this.c(1);
        this.b(483);
    ...
    public S_ProtoBuffers(L1PcInstance pc, String chatText, int chatCount) {
        this.c(1);
        this.b(515);
        PBMessageALL6.L1R_a.L1R_a builder = PBMessageALL6.L1R_a.aa();
        builder.a(chatCount);
        builder.b(1);
        builder.e(LineageUtil.a(chatText));
        builder.f(LineageUtil.a(pc.et()));
        builder.c(Config.a);
        builder.d(0);
        this.a(builder.M().g());
        this.b(0);
    ...
    public S_ProtoBuffers(int type, int val, String[] s, int[] data) {
        this.c(1);
        this.b(type);
        switch (type) {
            case 579: {
                ...
                while (i2 < data.length) {
                    PBMessageALL.L1R_g.L1R_a builder4 = PBMessageALL.L1R_g.aa();
                    builder4.e(LineageUtil.a(s[i2]));
                    if (data[i2] > 0) {
                        PBMessageALL.L1R_a.L1R_a builder1 = PBMessageALL.L1R_a.aa();
                        builder1.a(7);
                        builder1.b(data[i2]);
    ...
    public S_ProtoBuffers(L1PcInstance pc, String chatText, int chatType, int chatCount) {
        this.c(1);
        this.b(516);
        PBMessageALL5.L1R_i.L1R_a builder = PBMessageALL5.L1R_i.aa();
        builder.a(chatCount);
        builder.b(chatType);
        builder.e(LineageUtil.a(chatText));
        builder.f(LineageUtil.a(pc.et()));
    ...
    public S_ProtoBuffers(ArrayList<Integer> equipList_1, ArrayList<Integer> equipList_2, int page) {
        this.c(1);
        this.b(800);
        ...
        PBMessageALL3.L1R_a.L1R_a builder10 = PBMessageALL3.L1R_a.aa();
        builder10.b(page);
        PBMessageALL2.L1R_c.L1R_a builder = PBMessageALL2.L1R_c.s();
        PBMessageALL2.L1R_c.L1R_a builder2 = PBMessageALL2.L1R_c.s();
        builder.b(0);
    ...
    public S_ProtoBuffers(int type, L1QuestNew qn) {
        int i2;
        this.c(1);
        this.b(type);
        PBMessageALL5.L1R_a.L1R_a builder16 = PBMessageALL5.L1R_a.aa();
        builder16.b(qn.a());
        builder16.c(qn.y().fr());
        PBMessageALL.L1R_a.L1R_a builder1 = PBMessageALL.L1R_a.aa();
        int index = 1;
        ...
        builder16.e(1);
        PBMessageALL5.L1R_c.L1R_a builder = PBMessageALL5.L1R_c.aa();
        builder.e(builder16.M().f());
        this.a(builder.M().g());
        this.b(0);
    }

    public S_ProtoBuffers(int score, String name, L1ThebesBattle.L1R_g ... data) {
        L1ThebesBattle.L1R_g tr;
        this.c(1);
        this.b(133);
    ...
    public S_ProtoBuffers(int remainTime, int[] data) {
        this.c(1);
        this.b(134);
        PBMessageALL3.L1R_g.L1R_a builder = PBMessageALL3.L1R_g.aa();
        PBMessageALL.L1R_a.L1R_a builder1 = PBMessageALL.L1R_a.aa();
        builder1.a(4);
        builder1.b(data[0]);
        builder1.c(Config.a);
