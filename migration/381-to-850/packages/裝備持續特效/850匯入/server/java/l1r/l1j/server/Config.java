...
public final class Config {
   ...
   public static int ItemEnchantLevelBonusSwitch;
   public static int EquipmentContinuousEffectSwitch;
   public static int EquipmentContinuousEffectInterval;
   ...
   public static void a() {
      try {
         ...
         ItemEnchantLevelBonusSwitch = Integer.parseInt(var0.a("ItemEnchantLevelBonusSwitch", "1"));
         EquipmentContinuousEffectSwitch = Integer.parseInt(var0.a("EquipmentContinuousEffectSwitch", "1"));
         EquipmentContinuousEffectInterval = Integer.parseInt(var0.a("EquipmentContinuousEffectInterval", "15"));
