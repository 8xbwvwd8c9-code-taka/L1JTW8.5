...
public class DropMapTable {
   ...
   private void loadDesignatedDrops() {
      Connection var1 = null;
      PreparedStatement var2 = null;
      ResultSet var3 = null;
      ...
      try {
         var1 = DatabaseFactory.a().b();
         var2 = var1.prepareStatement("SELECT * FROM w_map_designated_drop");
         var3 = var2.executeQuery();
         ...
         // table might not be loaded if optional
      } catch (Exception var13) {
         a.log(Level.SEVERE, var13.getLocalizedMessage(), var13);
      } finally {
         SQLUtil.a(var3, var2, var1);
   ...
   public void a(L1NpcInstance var1) {
      if (Config.MapDesignatedDropSwitch != 1) {
         return;
      }
      if (var1 == null || var1.y() == null) {
         return;
      }

      // 1. 指定地圖專屬掉落
      processDropPool(var1, var1.fp());

      // 2. 全地圖通用掉落 (mapid = -1)
      if (Config.GlobalMapDropSwitch == 1) {
         processDropPool(var1, -1);
      }
   }

   private void processDropPool(L1NpcInstance var1, int mapId) {
      ...
      if (!(var2 <= 0.0) || !(var4 <= 0.0)) {
         for (DropMapTable.L1R_a var6 : this.c.get(mapId).b.values()) {
            L1ItemInstance var8 = ItemTable.a().b(var6.b);
            if (var8 != null && (var4 != 0.0 || var6.b != 40308)) {
