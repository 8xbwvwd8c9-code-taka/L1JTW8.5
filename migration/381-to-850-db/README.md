...
| `w_變身卡片能力組合套卡` | `BLOCKED` | `L3/L4` | [`TRANSFORM_CARD_COLLECTION_SET_AUDIT.md`](modules/TRANSFORM_CARD_COLLECTION_SET_AUDIT.md) | `892b69347ad25191ac899a9ea57ad8ce8a58b970` | Set quests own active bonuses; share collection ownership with base cards and share only numeric stat definitions, pending idempotent 850 recompute/UI mapping. |
| `w_自訂變形卷軸` | `BLOCKED` | `L4` | [`CUSTOM_POLYMORPH_SCROLL_AUDIT.md`](modules/CUSTOM_POLYMORPH_SCROLL_AUDIT.md) | `PENDING` | 850 native server mapping proven; action owner, item semantics and client resources remain unproven; do not port `ItemActionPoly`. |
