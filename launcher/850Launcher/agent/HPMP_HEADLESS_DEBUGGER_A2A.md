...
- Include SOURCE_MODIFIED=NO, TARGET_MEMORY_WRITE=NO, DEBUG_REGISTERS_USED=YES, CLIENT_AUTHORITY=1, PID/start time, module base, resolved gauge/watch addresses, hit counts, unique writer RVAs.
