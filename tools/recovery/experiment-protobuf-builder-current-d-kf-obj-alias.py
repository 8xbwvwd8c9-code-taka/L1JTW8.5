...
TMP=Path('recovery/compile-ref-protobuf-l1rpb.builder-current-d-kf-obj.jar')
OUT=Path('recovery/protobuf_builder_current_d_kf_obj_alias_experiment.json')
MD=Path('recovery/PROTOBUF_BUILDER_CURRENT_D_KF_OBJ_ALIAS_EXPERIMENT.md')

TARGET='l1rpb/p$a.class'
SRC=('a','(Ll1rpb/k$f;Ljava/lang/Object;)Ll1rpb/p$a;')
ALIAS=('d','(Ll1rpb/k$f;Ljava/lang/Object;)Ll1rpb/p$a;')
ERASED=('d','(Ll1rpb/k$f;Ljava/lang/Object;)Ll1rpb/x$a;')
...
state={
 'experiment':'BUILDER_CURRENT_D_KF_OBJECT_TYPED_ALIAS_P_A',
 'target_class':TARGET,
 ...
 'source_collision_scan':'zero d(k$f,Object) declarations found across PBMessageALL*.java recovered source',
 ...
 'pass_signal':'44 current d(k$f,Object) obligations disappear or advance; parser/nonprotobuf remain 0'
}
OUT.write_text(json.dumps(state,indent=2)+'\n',encoding='utf-8')
MD.write_text(
 '# Builder Current d(k$f,Object) Alias A/B\n\n'
 '- Adds exactly one recovery compile-ref typed alias at p$a.\n'
 '- Source collision scan: zero exact d(k$f,Object) declarations.\n'
 '- Donor provider-map proves synthetic d(k$f,Object)->x$a delegates to typed a(k$f,Object)->p$a with TBuilderType Signature.\n'
