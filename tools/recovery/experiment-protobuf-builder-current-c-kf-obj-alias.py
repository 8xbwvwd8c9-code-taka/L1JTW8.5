...
TMP=Path('recovery/compile-ref-protobuf-l1rpb.builder-current-c-kf-obj.jar')
OUT=Path('recovery/protobuf_builder_current_c_kf_obj_alias_experiment.json')
MD=Path('recovery/PROTOBUF_BUILDER_CURRENT_C_KF_OBJ_ALIAS_EXPERIMENT.md')

TARGET='l1rpb/p$a.class'
SRC=('b','(Ll1rpb/k$f;Ljava/lang/Object;)Ll1rpb/p$a;')
ALIAS=('c','(Ll1rpb/k$f;Ljava/lang/Object;)Ll1rpb/p$a;')
ERASED=('c','(Ll1rpb/k$f;Ljava/lang/Object;)Ll1rpb/x$a;')
...
state={
 'experiment':'BUILDER_CURRENT_C_KF_OBJECT_TYPED_ALIAS_P_A',
 'target_class':TARGET,
 ...
 'source_collision_scan':'zero c(k$f,Object) declarations found across PBMessageALL*.java recovered source',
 ...
 'pass_signal':'44 current c(k$f,Object) obligations disappear or advance; parser/nonprotobuf remain 0'
}
OUT.write_text(json.dumps(state,indent=2)+'\n',encoding='utf-8')
MD.write_text(
 '# Builder Current c(k$f,Object) Alias A/B\n\n'
 '- Adds exactly one recovery compile-ref typed alias at p$a.\n'
 '- Source collision scan: zero exact c(k$f,Object) declarations.\n'
 '- Donor provider-map proves synthetic c(k$f,Object)->x$a delegates to typed b(k$f,Object)->p$a with TBuilderType Signature.\n'
