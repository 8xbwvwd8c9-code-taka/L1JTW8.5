...
TMP=Path('recovery/compile-ref-protobuf-l1rpb.builder-current-d-g-n.jar')
OUT=Path('recovery/protobuf_builder_current_d_g_n_alias_experiment.json')
MD=Path('recovery/PROTOBUF_BUILDER_CURRENT_D_G_N_ALIAS_EXPERIMENT.md')

TARGET='l1rpb/a$a.class'
SRC=('a','(Ll1rpb/g;Ll1rpb/n;)Ll1rpb/a$a;')
ALIAS=('d','(Ll1rpb/g;Ll1rpb/n;)Ll1rpb/a$a;')
ERASED=('d','(Ll1rpb/g;Ll1rpb/n;)Ll1rpb/x$a;')
...
state={
 'experiment':'BUILDER_CURRENT_D_G_N_TYPED_ALIAS',
 'target_class':TARGET,
 ...
 'source_collision_scan':'zero d(g,n) declarations found across PBMessageALL*.java recovered source',
 ...
 'pass_signal':'44 current d(g,n) obligations disappear or advance; parser/nonprotobuf remain 0'
}
OUT.write_text(json.dumps(state,indent=2)+'\n',encoding='utf-8')
MD.write_text(
 '# Builder Current d(g,n) Alias A/B\n\n'
 '- Adds exactly one recovery compile-ref typed alias.\n'
 '- Source collision scan: zero exact d(g,n) declarations.\n'
 '- Donor provider-map proves synthetic d(g,n)->x$a delegates to typed a(g,n)->a$a with TBuilderType Signature.\n'
