...
cmd=["java","-jar",str(CFR),str(SRC),"--outputdir",str(OUT),"--silent","true",
     "--innerclasses","false","--skipbatchinnerclasses","false","--removeinnerclasssynthetics","false"]
...
state={"source_jar":str(SRC),"cfr_exit_code":p.returncode,"runtime_class_files":len(classes),
       "java_files_copied":len(java),"innerclasses":False,"skipbatchinnerclasses":False,"removeinnerclasssynthetics":False,
