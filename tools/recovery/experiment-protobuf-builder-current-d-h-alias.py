...
TMP=Path('recovery/compile-ref-protobuf-l1rpb.builder-current-d-h.jar')
OUT=Path('recovery/protobuf_builder_current_d_h_alias_experiment.json')
MD=Path('recovery/PROTOBUF_BUILDER_CURRENT_D_H_ALIAS_EXPERIMENT.md')

TARGET='l1rpb/a$a.class'
SRC=('a','(Ll1rpb/h;)Ll1rpb/a$a;')
ALIAS=('d','(Ll1rpb/h;)Ll1rpb/a$a;')
ERASED=('d','(Ll1rpb/h;)Ll1rpb/x$a;')
...
state={
 'experiment':'BUILDER_CURRENT_D_H_TYPED_ALIAS_A_A',
 'target_class':TARGET,
 ...
 'source_collision_scan':'zero d(h) declarations found across PBMessageALL*.java recovered source',
 ...
 'pass_signal':'44 current d(h) obligations disappear or advance; parser/nonprotobuf remain 0'
}
OUT.write_text(json.dumps(state,indent=2)+'\n',encoding='utf-8')
MD.write_text(
 '# Builder Current d(h) Alias A/B\n\n'
 '- Adds exactly one recovery compile-ref typed alias at a$a.\n'
 '- Source collision scan: zero exact d(h) declarations.\n'
 '- Donor provider-map proves synthetic d(h)->x$a delegates to typed a(h)->a$a with TBuilderType Signature.\n'
