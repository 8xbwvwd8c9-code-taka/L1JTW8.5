...
TMP=Path('recovery/compile-ref-protobuf-l1rpb.builder-current-d-h-n.jar')
OUT=Path('recovery/protobuf_builder_current_d_h_n_alias_experiment.json')
MD=Path('recovery/PROTOBUF_BUILDER_CURRENT_D_H_N_ALIAS_EXPERIMENT.md')

TARGET='l1rpb/a$a.class'
SRC=('a','(Ll1rpb/h;Ll1rpb/n;)Ll1rpb/a$a;')
ALIAS=('d','(Ll1rpb/h;Ll1rpb/n;)Ll1rpb/a$a;')
ERASED=('d','(Ll1rpb/h;Ll1rpb/n;)Ll1rpb/x$a;')
...
if name_idx is None: raise SystemExit('missing Utf8 d')
...
state={
 'experiment':'BUILDER_CURRENT_D_H_N_TYPED_ALIAS_A_A_POST176',
 'target_class':TARGET,
 ...
 'source_collision_gate':'run229 normalization removed 44 builder d(h,n) VF bridges; residual builder d(h,n)=0; parser Object d(h,n) preserved 44->44',
 'provider_choice':'single donor-proven a$a provider',
 ...
 'pass_signal':'44 current d(h,n) obligations disappear or advance; parser/nonprotobuf remain 0'
}
OUT.write_text(json.dumps(state,indent=2)+'\n',encoding='utf-8')
MD.write_text(
 '# Builder Current d(h,n) Alias A/B — Post-176\n\n'
 '- Adds exactly one recovery compile-ref typed alias at a$a.\n'
 '- Run229 removed all 44 conflicting concrete builder source bridges; residual=0.\n'
 '- Parser Object d(h,n) bridges remain 44/44.\n'
 '- Donor provider-map proves synthetic d(h,n)->x$a delegates to typed a(h,n)->a$a with TBuilderType Signature.\n'
