...
TMP=Path('recovery/compile-ref-protobuf-l1rpb.builder-current-d.jar')
OUT=Path('recovery/protobuf_builder_current_d_alias_experiment.json')
MD=Path('recovery/PROTOBUF_BUILDER_CURRENT_D_ALIAS_EXPERIMENT.md')

TARGET='l1rpb/a$a.class'
SRC=('a','([BIILl1rpb/n;)Ll1rpb/a$a;')
ALIAS=('d','([BIILl1rpb/n;)Ll1rpb/a$a;')
ERASED=('d','([BIILl1rpb/n;)Ll1rpb/x$a;')
...
state={
 'experiment':'BUILDER_CURRENT_D_BYTE4_TYPED_ALIAS',
 'target_class':TARGET,
 ...
 'pass_signal':'44 current d(byte[],int,int,n) builder obligations disappear or advance; parser/nonprotobuf stay 0'
}
OUT.write_text(json.dumps(state,indent=2)+'\n',encoding='utf-8')
MD.write_text(
 '# Builder Current d(byte[],int,int,n) Alias A/B\n\n'
 '- Adds exactly one recovery compile-ref typed alias.\n'
 '- Copies donor-proven typed a(byte[],int,int,n)->a$a method_info as d(...)->a$a.\n'
