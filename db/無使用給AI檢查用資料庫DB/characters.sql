CREATE TABLE `characters` (
  ...
  `TamUseTime` datetime DEFAULT NULL,
  ...
  `EinhasadsBless` int(10) NOT NULL DEFAULT '0',
  `BookMarkSpace` int(3) NOT NULL DEFAULT '60',
  `CharStoreSpace` int(3) NOT NULL DEFAULT '0',
  `RuneOpenStatus` int(3) NOT NULL DEFAULT '3',
  `WsaRecord` int(10) NOT NULL DEFAULT '0',
  `MapTime_1` int(10) NOT NULL DEFAULT '10800',
  `MapTime_2` int(10) NOT NULL DEFAULT '3600',
  `MapTime_3` int(10) NOT NULL DEFAULT '10800',
  `MapTime_4` int(10) NOT NULL DEFAULT '10800',
  `MapTime_5` int(10) NOT NULL DEFAULT '3600',
  `MapTime_6` int(10) NOT NULL DEFAULT '7200',
  `MapTime_7` int(10) NOT NULL DEFAULT '7200',
  PRIMARY KEY (`objid`),
